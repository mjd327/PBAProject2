...
public class ParticleSystemBuilder implements GLEventListener
{
    ...
    private static int N_STEPS_PER_FRAME = 3;
	...
	{
		//TODO: Change this implementation because it's really stupid. 
		if(PS.F.size() == 0)
		{
			Gravity g = new Gravity(PS);  
			PS.addForce(g);
		}
    ...
    {
    	JFileChooser fc = new JFileChooser("/Users/Alec/Desktop/Cornell Spring 14/Physically Based Animation/PBAProject2/A2Starter-2-4/src");
